      ...
      <table>
         ...
         @foreach ($appoints as $appoint)
          <tr align="center">
              ...
              <td style="padding: 10px; font-size:20px; color:black;"><a class="btn btn-danger" onclick="return confirm('are you sure to delete this')" href="{{url('cancel_appoint',$appoint->id)}}">Cancel</a></td>
          </tr>
          @endforeach
      </table>
  </div>
